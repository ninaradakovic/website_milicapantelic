  ...
  var Plugin = /*#__PURE__*/function () {
    ...
    _createClass(Plugin, [{
      ...
      value: function _addImages() {
        ...
        $.each(this.imageArray, function (i, _ref) {
          var src = _ref.src,
              alt = _ref.alt;
          var $img = $("<img class=\"invisible\" src=\"".concat(src, "\" alt=\"").concat(alt || 'Slideshow image', "\"/>"));
          var $figure = $("<figure class=\"ld-slideshow-figure\" style=\"background-image: url(".concat(src, ")\" />"));
  ...
  var Plugin = /*#__PURE__*/function () {
    ...
    _createClass(Plugin, [{
      ...
      value: function onShown(event) {
        ...
        var $window = $(window);
        var $stickyHeader = $('[data-sticky-header]');
        var scrollVal = this.$element.offset().top - 45;
...
jQuery(document).ready(function ($) {
  $('.lqd-contact-form, form.cart, form.checkout, form.woocommerce-cart-form, form.woocommerce-ordering').liquidFormInputs();
});
"use strict";
