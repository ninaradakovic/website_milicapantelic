...
/*
		array(
			...
			'subtitle' => '',
			'desc'     => wp_kses_post( __( 'Follow the link <a target="_blank" href="https://instagram.com/oauth/authorize/?client_id=2340bf75213b4c729e6d234077c1d09f&scope=basic&response_type=code&redirect_uri=https://api.liquid-themes.com/instagram/instagram-auth.php">to generate the access token and user ID.</a>', 'ave' ) ),
		),
*/
	)
);
